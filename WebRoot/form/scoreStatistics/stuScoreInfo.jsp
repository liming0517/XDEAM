				...
				onLoadSuccess:function(data){
					...
					if(data != ''){
						...
						xnxqVal=$('#XNXQ').combobox('getValue');
							...
							var stuid=iUSERCODE;
							var name=userName;
							$('#index').html('<table style="width:100%;height:30px;font-size:20px;line-height:30px;" ><tr><td width="20%"><a href="<%=request.getContextPath()%>/form/scoreStatistics/download.jsp">补考安排表下载</a></td><td width="60%" align="center">'+name+'</td><td width="20%"></td></tr></table><table class="easyui-datagrid" id="List" ></table>');
							$.parser.parse(('#index'));
							loadGrid2(stuid);
