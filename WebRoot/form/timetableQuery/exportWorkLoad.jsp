...
<%
	...
	String TEAID = MyTools.StrFiltr(URLDecoder.decode(URLDecoder.decode(request.getParameter("TEAID"),"utf-8"),"utf-8"));
	String TEANAME = MyTools.StrFiltr(URLDecoder.decode(URLDecoder.decode(request.getParameter("TEANAME"),"utf-8"),"utf-8"));

	if("workLoad".equalsIgnoreCase(exportType)){
		ExportExcelBean.exportWorkLoad(request, exportType, XNXQ, TEAID, TEANAME);
	}else if("teachSituation".equalsIgnoreCase(exportType)){
		ExportExcelBean.exportTeachSituation(request, exportType, XNXQ, TEAID, TEANAME);
	}
%>
<html>
<head>
