...
<%
	...
	String ksxs = MyTools.StrFiltr(request.getParameter("ksxs"));
	String titleinfo = MyTools.StrFiltr(URLDecoder.decode(request.getParameter("titleinfo"),"utf-8"));
	if("examCourse".equalsIgnoreCase(exportType)){
		ExportExcelBean.exportExamCourse(request, exportType, xnxq, jxxz, qzqm, ksxs, titleinfo);
	}
%>
<html>
<head>
