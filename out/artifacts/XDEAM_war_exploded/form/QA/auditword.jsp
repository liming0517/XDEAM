    ...
    <po:PageOfficeCtrl id="PageOfficeCtrl1" />
      ...
      <script type="text/javascript">
    		...
    		function show_auditedit(){
				...
				OpenWindow.document.writeln('<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/themes/default/easyui.css">');
				OpenWindow.document.writeln('<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/themes/icon.css">');
