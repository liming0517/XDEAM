...
<%
	...
	if("xnxqXqk".equalsIgnoreCase(exportType)){
			 ...
			 filePath =bean.stuXqkView(request,exportType,JX_XJH,BJBH,XM); 
	} else{
			 ...
			 BJBH = MyTools.StrFiltr(request.getParameter("BJBH"));
			 filePath =bean.stuXqkMuchView(request,XBDM,NJDM,SSZY,BJBH); 
		}  
	...
	<body style="margin:0;" scroll="no">
		...
		<script language="javascript" type="text/javascript">
			...
			function delViewFile(){
				...
				/**下载学生学籍卡*/
		  	function downXJK(){
		  		$("#exportIframe").attr("src", '<%=request.getContextPath()%>/download.jsp?filePath=' +encodeURI(encodeURI(viewFilePath)));
			}
		</script>
