...
<BODY  style="margin-top:3px;text-align:center;background: url('images/dl_tc.png');background-repeat: repeat; overflow:hidden;">

<!--总div_begin-->
<div style="background:url('images/Login/xdzx_login_xxkglxt.png'); margin:0 auto; width:983px; height:520px;">
   ...
   // alert("onsubmit")
    ...
    success:function(data){
        ...
        if(a=="1"){
        	...
        	location.href="<%=request.getContextPath()%>/form/elective/studentApplication.jsp";
        }  
    }
});
