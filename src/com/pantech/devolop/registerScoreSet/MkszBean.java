...
public class MkszBean {
	 ...
	 * @param request
	 */
	public MkszBean(HttpServletRequest request) {
	 ...
	 * @throws SQLException
	 */
	public Vector loadStuMkmd(String ic_cjlx)throws SQLException{
		Vector vec = null;
		...
		if("ps".equalsIgnoreCase(ic_cjlx)){
			sql = "select 学号,姓名 from V_成绩管理_学生成绩信息表 where 相关编号='" + MyTools.fixSql(this.getCX_XGBH()) + "' and 成绩状态='1' and 平时='-17'";
		}
		if("qz".equalsIgnoreCase(ic_cjlx)){
			sql = "select 学号,姓名 from V_成绩管理_学生成绩信息表 where 相关编号='" + MyTools.fixSql(this.getCX_XGBH()) + "' and 成绩状态='1' and 期中='-17'";
		}
		if("sx".equalsIgnoreCase(ic_cjlx)){
			sql = "select 学号,姓名 from V_成绩管理_学生成绩信息表 where 相关编号='" + MyTools.fixSql(this.getCX_XGBH()) + "' and 成绩状态='1' and 实训='-17'";
		}
		if("qm".equalsIgnoreCase(ic_cjlx)){
			sql = "select 学号,姓名 from V_成绩管理_学生成绩信息表 where 相关编号='" + MyTools.fixSql(this.getCX_XGBH()) + "' and 成绩状态='1' and 期末='-17'";
		}
		vec = db.GetContextVector(sql);
	 ...
	 * @throws SQLException
	 */
	public void saveMkStu(String ic_cjlx)throws SQLException{
		Vector sqlVec = new Vector();
		String sql = ""; 
		
		if("ps".equalsIgnoreCase(ic_cjlx)){
			sql = "update V_成绩管理_学生成绩信息表 set 平时 = (case 平时 when '-17' then '' else 平时 end) where 相关编号 = '" + MyTools.fixSql(this.getCX_XGBH()) +"'";
		}
		if("qz".equalsIgnoreCase(ic_cjlx)){
			sql = "update V_成绩管理_学生成绩信息表 set 期中 =(case 期中 when '-17' then '' else 期中 end) where 相关编号 = '" + MyTools.fixSql(this.getCX_XGBH()) +"'";
		}
		if("sx".equalsIgnoreCase(ic_cjlx)){
			sql = "update V_成绩管理_学生成绩信息表 set 实训 =(case 实训 when '-17' then '' else 实训 end) where 相关编号 = '" + MyTools.fixSql(this.getCX_XGBH()) +"'";
		}
		if("qm".equalsIgnoreCase(ic_cjlx)){
			sql = "update V_成绩管理_学生成绩信息表 set 期末 =(case 期末 when '-17' then '' else 期末 end) where 相关编号 = '" + MyTools.fixSql(this.getCX_XGBH()) +"'";
		}
		sqlVec.add(sql);
		
		if("ps".equalsIgnoreCase(ic_cjlx)){
			sql = "update V_成绩管理_学生成绩信息表 set 平时 = '-17' where 学号 in ('" + this.getCX_XH().replaceAll(",", "','") + "') AND 相关编号 = '" + MyTools.fixSql(this.getCX_XGBH()) +"'";
		}
		if("qz".equalsIgnoreCase(ic_cjlx)){
			sql = "update V_成绩管理_学生成绩信息表 set 期中 = '-17' where 学号 in ('" + this.getCX_XH().replaceAll(",", "','") + "') AND 相关编号 = '" + MyTools.fixSql(this.getCX_XGBH()) +"'";
		}
		if("sx".equalsIgnoreCase(ic_cjlx)){
			sql = "update V_成绩管理_学生成绩信息表 set 实训 = '-17' where 学号 in ('" + this.getCX_XH().replaceAll(",", "','") + "') AND 相关编号 = '" + MyTools.fixSql(this.getCX_XGBH()) +"'";
		}
		if("qm".equalsIgnoreCase(ic_cjlx)){
			sql = "update V_成绩管理_学生成绩信息表 set 期末 = '-17' where 学号 in ('" + this.getCX_XH().replaceAll(",", "','") + "') AND 相关编号 = '" + MyTools.fixSql(this.getCX_XGBH()) +"'";
		}
		sqlVec.add(sql);
	 ...
	 * @throws SQLException
	 */
	public void saveStuMkCourse(String ic_plcjlx)throws SQLException{
		Vector sqlVec = new Vector();
		String sql = ""; 
		
		if("ps".equalsIgnoreCase(ic_plcjlx)){
			sql = "update V_成绩管理_学生成绩信息表 set 平时 = (case 平时 when '-17' then '' else 平时 end) " +
		...
		if("qz".equalsIgnoreCase(ic_plcjlx)){
			sql = "update V_成绩管理_学生成绩信息表 set 期中 =(case 期中 when '-17' then '' else 期中 end) " +
					"where 编号 in (select a.编号 from V_成绩管理_学生成绩信息表 a " +
					"left join V_成绩管理_科目课程信息表 b on b.科目编号=a.科目编号 " +
					"left join V_学生基本数据子类 c on c.学号=a.学号 " +
					"where a.状态='1' and b.状态='1' and a.成绩状态='1' and c.学生状态 in ('01','05') " +
		...
		if("sx".equalsIgnoreCase(ic_plcjlx)){
			sql = "update V_成绩管理_学生成绩信息表 set 实训 =(case 实训 when '-17' then '' else 实训 end) " +
					"where 编号 in (select a.编号 from V_成绩管理_学生成绩信息表 a " +
					"left join V_成绩管理_科目课程信息表 b on b.科目编号=a.科目编号 " +
					"left join V_学生基本数据子类 c on c.学号=a.学号 " +
					"where a.状态='1' and b.状态='1' and a.成绩状态='1' and c.学生状态 in ('01','05') " +
		...
		if("qm".equalsIgnoreCase(ic_plcjlx)){
			sql = "update V_成绩管理_学生成绩信息表 set 期末 =(case 期末 when '-17' then '' else 期末 end) " +
					"where 编号 in (select a.编号 from V_成绩管理_学生成绩信息表 a " +
					"left join V_成绩管理_科目课程信息表 b on b.科目编号=a.科目编号 " +
					"left join V_学生基本数据子类 c on c.学号=a.学号 " +
					"where a.状态='1' and b.状态='1' and a.成绩状态='1' and c.学生状态 in ('01','05') " +
		...
		if("ps".equalsIgnoreCase(ic_plcjlx)){
			sql = "update V_成绩管理_学生成绩信息表 set 平时 = '-17'" +
					"where 编号 in (select a.编号 from V_成绩管理_学生成绩信息表 a " +
					"left join V_成绩管理_科目课程信息表 b on b.科目编号=a.科目编号 " +
					"left join V_学生基本数据子类 c on c.学号=a.学号 " +
					"where a.状态='1' and b.状态='1' and a.成绩状态='1' and c.学生状态 in ('01','05') " +
		...
		if("qz".equalsIgnoreCase(ic_plcjlx)){
			sql = "update V_成绩管理_学生成绩信息表 set 期中 = '-17'" +
					"where 编号 in (select a.编号 from V_成绩管理_学生成绩信息表 a " +
					"left join V_成绩管理_科目课程信息表 b on b.科目编号=a.科目编号 " +
					"left join V_学生基本数据子类 c on c.学号=a.学号 " +
					"where a.状态='1' and b.状态='1' and a.成绩状态='1' and c.学生状态 in ('01','05') " +
		...
		if("sx".equalsIgnoreCase(ic_plcjlx)){
			sql = "update V_成绩管理_学生成绩信息表 set 实训 = '-17'" +
					"where 编号 in (select a.编号 from V_成绩管理_学生成绩信息表 a " +
					"left join V_成绩管理_科目课程信息表 b on b.科目编号=a.科目编号 " +
					"left join V_学生基本数据子类 c on c.学号=a.学号 " +
					"where a.状态='1' and b.状态='1' and a.成绩状态='1' and c.学生状态 in ('01','05') " +
		...
		if("qm".equalsIgnoreCase(ic_plcjlx)){
			sql = "update V_成绩管理_学生成绩信息表 set 期末 = '-17'" +
					"where 编号 in (select a.编号 from V_成绩管理_学生成绩信息表 a " +
					"left join V_成绩管理_科目课程信息表 b on b.科目编号=a.科目编号 " +
					"left join V_学生基本数据子类 c on c.学号=a.学号 " +
					"where a.状态='1' and b.状态='1' and a.成绩状态='1' and c.学生状态 in ('01','05') " +
	 ...
	 * @throws SQLException
	 */
	public Vector loadStuPLMkmd(String ic_plcjlx)throws SQLException{
		String sql = ""; // 查询用SQL语句
		Vector vec = null; // 结果集
		Vector resultVec = new Vector();
		String stuCode = "";
